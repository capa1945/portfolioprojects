...
-- Share of people who received at least one dose of COVID-19 vaccine in New Zealand
-- Total number of people who received at least one vaccine dose, divided by the total population of New Zealand.
...
SELECT 
    ...
    people_vaccinated,
    population,
    ROUND((people_vaccinated / population) * 100, 2) AS share_people_vaccinated
FROM
    covid_vaccination
        LEFT JOIN
    geo_info USING (iso_code)
...
-- Monthly share of the population receriving a Covid-19 vaccine dose in New Zealand
